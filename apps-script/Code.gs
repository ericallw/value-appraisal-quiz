...
// 卡片級 offer —— 每張卡「可以點樣賣、賣畀邊個」。
// 三條界線：①唔寫價錢（市價會變，觀眾自己定）②唔聲稱「市場上有人賣緊」，只寫「可以這樣賣」
// ③C 類（情緒承接）一律同輔導／治療劃清界線，只寫陪伴同整理。
// 呢個表只喺 PDF 出，結果頁維持類別級——最具體嗰層係留 email 嘅理由。
var OFFER = {
  1: { sell: "按月收單據，月底交一張分類好的支出表，標出哪幾筆該留給會計。", buyer: "自己開店或接案、報稅前一晚才發現單據亂成一團的人。" },
  2: { sell: "到現場跟一天，交一份新人照著做就能上手的操作手冊。", buyer: "每請一次新人就要從頭再講一次的小店老闆。" },
  3: { sell: "接手對方一週的行事曆，重排成不撞期、留得出空檔的版本。", buyer: "會議排到沒時間做事的人。" },
  4: { sell: "一次通話，把那個「總有一天」的計劃拆成第一週的三件事。", buyer: "想開始副業、卻一直卡在第一步的上班族。" },
  5: { sell: "上門三小時，把衣櫃整理到每件衣服都拿得出來，附一張搭配清單。", buyer: "衣服很多、卻每天早上覺得沒衣服穿的人。" },
  6: { sell: "每月把散亂的帳單整理成一張「錢花去哪」的表，標出三個可以砍的地方。", buyer: "想存錢、但講不出錢花在哪的人。" },
  7: { sell: "開一次會，把工作切成「誰負責哪一塊、什麼時候交」的一頁表。", buyer: "三五個人一起做、但事情總是掉在中間的小團隊。" },
  8: { sell: "把散在十幾個地方的資料收成一個查得到的系統，再教對方怎麼放新東西進去。", buyer: "存了很多、但每次都找不到的人。" },
  9: { sell: "對方傳一份文件，你回一頁「這份在講什麼、要小心哪三行」的白話摘要。", buyer: "第一次簽合作合約、又不想找律師的接案者。" },
  10: { sell: "逐條讀完，交一份標好風險高低的重點清單，附上該回頭問對方的問題。", buyer: "要簽約、但看不出哪裡有陷阱的小生意主。" },
  11: { sell: "每月挑一本書，交一份十分鐘讀得完的重點加三個可以馬上用的做法。", buyer: "想吸收、但讀不完一本書的人。" },
  12: { sell: "收三到五個選項，交一張比較表加一句「你的情況該選哪個」。", buyer: "研究到頭昏、遲遲下不了決定的人。" },
  13: { sell: "一對一帶著操作，教到對方自己做得到為止，附一份步驟截圖。", buyer: "買了工具卻用不起來的人。" },
  14: { sell: "每月看一次對方的數字，交一頁「這個月真正該注意的那一個變化」。", buyer: "有報表、但看不出重點的小店老闆。" },
  15: { sell: "聽對方講一次，交一張把整個流程畫清楚的圖，可以直接貼在牆上。", buyer: "每次都要重新解釋同一件事的人。" },
  16: { sell: "一次模擬面試加逐題回饋，指出哪裡會被問倒、可以怎麼答。", buyer: "準備轉工、怕臨場答不出的人。" },
  17: { sell: "固定時段的一對一傾談，不給建議，只把對方講出來的東西整理回去給他。", buyer: "需要一個固定出口、但還不到要看醫生的人。" },
  18: { sell: "在對方的重要場合當現場定海神針，出狀況時第一個接住。", buyer: "第一次辦活動、怕現場失控的人。" },
  19: { sell: "當中間人，分別聽兩邊各講一次，再約一次三個人的對話。", buyer: "合夥人或家人之間卡住、誰先開口都尷尬的情況。" },
  20: { sell: "陪同出席那件他一個人不敢去的事，事前先對一次要說的話。", buyer: "要去談判、看醫生、面對面處理難事的人。" },
  21: { sell: "在雙方同意下，替小團隊做定期的一對一關心談話，把苗頭提早講出來。", buyer: "團隊有人突然離職才知道出事的小老闆。" },
  22: { sell: "一次四十五分鐘通話，把對方覺得世界末日那件事，重新講成一個可以處理的問題。", buyer: "剛出事、腦裡一片黑的人。" },
  23: { sell: "按更次的陪護，家屬不在時把人照顧好，交一份當更記錄。", buyer: "家人生病、自己請不了假的上班族。" },
  24: { sell: "上台或見客前的一小時陪練，把緊張壓到做得到的程度。", buyer: "要簡報、要見大客、一緊張就講不好的人。" },
  25: { sell: "收一張「送給誰、什麼場合、預算多少」的表，兩天內回三個選項加一句送禮的話。", buyer: "忙到沒時間挑、又不想送得敷衍的上班族。" },
  26: { sell: "按人數、場合、口味，交三間不會踩雷的餐廳加訂位建議。", buyer: "要請客、輸不起那一頓的人。" },
  27: { sell: "用對方衣櫃裡現有的衣服，配出五套可以直接穿出門的組合，拍照留檔。", buyer: "不想買新衣服、但每天都穿錯的人。" },
  28: { sell: "交一份「該買哪個、為什麼、哪個絕對不要」的推薦，附上比較理由。", buyer: "面對一堆差不多的產品、怕買錯的人。" },
  29: { sell: "從幾百張照片裡選出可以用的那幾張，附一句為什麼是這張。", buyer: "拍了很多、但貼出來總是不好看的人。" },
  30: { sell: "一次交十個名字或標題選項，附上每個的理由，改到滿意為止。", buyer: "開新店、開新帳號、卡在名字的人。" },
  31: { sell: "收齊條件之後直接給一個答案：買這個。附一句理由，不給選項。", buyer: "已經研究到累、只想有人替他決定的人。" },
  32: { sell: "按需求找出來源、店家或門路，交一份聯絡方式加怎麼開口的說法。", buyer: "找了很久都找不到、也不知道該問誰的人。" },
  33: { sell: "對方語音講二十分鐘，你交一份可以直接拿去見客的簡報。", buyer: "講得出、但排不出版面的老闆和業務。" },
  34: { sell: "收件檢查、報價、修好寄回，附一張「以後怎麼用才不會再壞」的提醒。", buyer: "東西壞了、但捨不得丟的人。" },
  35: { sell: "收一段素材，交一條有頭有尾、有人看得完的短片，附字幕。", buyer: "有素材、但剪不出來的小店和個人帳號。" },
  36: { sell: "每週一次的家常菜，按對方口味和忌口配菜單。", buyer: "想吃得好、但沒時間煮的家庭。" },
  37: { sell: "聽對方講一次，交一段他自己也認得出是自己聲音的文字。", buyer: "有故事、但寫不出來的老闆。" },
  38: { sell: "收一堆文字，交一張看得舒服、可以直接拿去用的版面。", buyer: "內容有了、但做出來很醜的人。" },
  39: { sell: "把一件每週要人手做的事搭成自動跑的流程，附一份出事時怎麼辦的說明。", buyer: "每週固定花幾小時做重複工作的小生意。" },
  40: { sell: "到現場一次，交一份佈置方案加採購清單，對方可以自己執行。", buyer: "開新店、辦活動、想要一進門就有感覺的人。" },
  41: { sell: "每天一次打卡，交不出就打電話，直到那件事真的做完。", buyer: "拖了很久、自己一個逼不動自己的人。" },
  42: { sell: "當一件事的統籌，把人分好、時間排好、盯到交付。", buyer: "有一群人、但沒有人負責推的團體。" },
  43: { sell: "一次通話，把「我想變好」變成三個月內做得到、看得見的具體目標。", buyer: "有心、但每次都訂到做不到的人。" },
  44: { sell: "固定的每週對話，在對方最想放棄那幾週陪他走完。", buyer: "正在做一件要很久才見效的事的人。" },
  45: { sell: "交一套新人上手流程加兩週的帶教安排，之後老闆不用再逐個教。", buyer: "每次請人都要親自帶到累的老闆。" },
  46: { sell: "當會議主持人，會前收議題、會中控節奏、會後交一頁決議。", buyer: "開很多會、但開不出結論的團隊。" },
  47: { sell: "事前幫對方想清楚要爭取什麼、怎麼開口、底線在哪，再陪他練一次。", buyer: "想加薪、想談價、但開不了口的人。" },
  48: { sell: "一次四十五分鐘的解卡通話，當場把那件事切成三個今天做得完的動作，收線前約好下週對一次。", buyer: "一個人做決定、沒有人 push 的自僱者和小店主。" }
};
...
function buildPdf(data) {
  ...
  // 卡片級 offer：由類別級（上面兩行）再落一層到「呢張卡可以點賣」。
  // 搵唔到就靜靜哋跳過，類別級嗰兩行照樣企喺度做後備。
  var offer = OFFER[data.lockedCardId];
  if (offer) {
    pdfBox(body, "可以這樣賣", offer.sell);
    pdfBox(body, "誰會買", offer.buyer);
  }
